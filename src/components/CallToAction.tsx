...
export function CallToAction() {
  return (
    <section
      ...
      className="relative isolate overflow-hidden bg-white bg-gradient-to-r py-32"
    >

      <Container className="mx-auto max-w-2xl">
        <div className="relative isolate overflow-hidden px-32 ring-1 ring-white/30 rounded-2xl drop-shadow-xl bg-slate-900 py-32 text-center">
